...
import McqsViewer from "../McqsViewer";
import TFViewer from "../TfViewer";
...
const QuizViewer = () => {
  return (
    <div className="p-4 mx-auto">
      ...
      {/* show mxqs */}
      {sampleQuizData.mcqs && (<h1 className="text-2xl font-bold text-left my-6">MCQS</h1>)}
      ...
      {/* show true false */}
      {sampleQuizData.truefalse && (<h1 className="text-2xl font-bold text-left mt-20 mb-6">True/False</h1>)}
      <div className="space-y-2">
        {sampleQuizData.truefalse?.map((question) => (
            <TFViewer key={question.id} question={question} />
        )) || " "}
      </div>
