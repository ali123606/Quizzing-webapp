      ...
      <main className="flex-grow flex flex-col items-center justify-center bg-gray-100 p-6">
        <div className="bg-white shadow-lg p-6 rounded-lg max-w-lg w-full">
          ...
          <div className="space-y-3">
            {["mcqs", "T/F", "Short Question", "Fill in the blanks", "Scenario-based question"].map(
              (type) => (
                <label
                  key={type}
                ...
                >
                  ...
                  <div
                    className={`w-5 h-5 rounded-full border-2 ${
                      questionType === type ? "bg-gray-800 border-gray-800" : "border-gray-400"
                    }`}
                  ></div>
          ...
          <button
            ...
            onClick={() => alert(`Question Generated: ${question}`)}
          >
            Generate
          </button>
        </div>
